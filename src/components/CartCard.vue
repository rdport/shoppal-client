  ...
  <div class="col mt-4">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text border-secondary border border-5 border-left-0 border-right-0">{{ formatCurrency(cart.Product.price) }}</p>
        ...
        <p v-if="quantity <= cart.Product.stock" class="card-text border-secondary border border-5 border-left-0 border-right-0">Subtotal: {{ formatCurrency(subtotal) }}</p>
