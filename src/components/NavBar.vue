...
<div>
  <b-navbar toggleable="lg" type="light" variant="light">
    <b-navbar-brand :to="{ name: 'Home' }" style="font-weight: bold;">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav>
        <b-nav-item @click="$emit('showInfo')"><img src="../assets/info.svg" style="position:relative;top:-0.2rem" width="30" height="30" alt="info icon">
            Info
        </b-nav-item>
      </b-navbar-nav>
