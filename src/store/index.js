  ...
  actions: {
    ...
    checkout (context, payload) {
      ...
      for (let i = 0; i < context.state.inStockCarts.length; i++) {
        ...
        const accessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJqb2huZG9lQG1haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNzM4NDQyOTQ3fQ.lkYbtE7dri2JjJwlQ3O2rb9HHakBW-DTMLKIRHOp1nw'
        promises.push(
          axios
            ...
            .then((response) => {
              ...
              return axios
                .post('/histories/add', historyData, { headers: { access_token: localStorage.getItem('access_token') } })
                .then((response) => {
                  results.push(response)
                  return axios
